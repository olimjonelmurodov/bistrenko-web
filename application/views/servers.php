			...
			<div class="row">
				...
				<div class="col-md-12 p-3 d-flex">
					<div class="flex-grow-1">
						<h2 class="grid-title">Xodimlar</h2>
					</div>
<?php if (hasadminrights()){?>     
					<div class="ml-auto">
						...
						<a class="btn btn-primary text-light" data-toggle="modal" data-target="#compose-modal"><i class="fa fa-plus"></i>&nbsp;&nbsp;Yangi Xodim</a>
						</form>						
<?php }?>  
				</div>
			</div>
		...
		echo '<td class="name">'.$item->place.'</td>';		
		echo '<td class="action text-right">
                ...
                <a class="btn btn-primary btn-sm text-white delete" href="'.site_url('servers/editserver?id=').$item->id.'"><i class="fa fa-pencil-alt fa-fw"></i></a>
                <a class="btn btn-danger btn-sm text-white delete" href="'.site_url('servers/deleteserver?id=').$item->id.'" data-confirm="Aniq o\'chirmoqchimisiz?"><i class="fa fa-trash fa-fw"></i></a>
                </td>';
		echo '</tr>';
}
?>
								...
								<div class="modal-content">
									<div class="modal-header bg-blue">
										<div class="d-flex  bd-highlight">
										  <div class="p-2 bd-highlight"><h4 class="modal-title">Yangi Xodim</h4></div>
										</div>
										<div class="d-flex flex-row-reverse bd-highlight">
										  <div class="p-2 bd-highlight"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button></div>
										</div>
									</div>
									<form action="<?php echo site_url('servers/addserver') ?>" method="post">
										...
										<div class="modal-footer">
											...
											<button type="submit" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Xodim qo'shish</button>
										</div>
									</form>
								</div>
							</div>
